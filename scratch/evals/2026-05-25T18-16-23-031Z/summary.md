...
- Run ID: `2026-05-25T18-16-23-031Z`
- Run mode: `degraded-mcp`
- Generated: `2026-05-25T18:16:25.586Z`
- Status: **below parity**
- Overall score: **34.78%**
...
- `degraded-mcp_verification_incomplete` on `mcp-degraded-server-sequencing`: Run mode degraded-mcp requires task mcp-degraded-server-sequencing to pass in order to count as a completed verification mode.
...
Status: below parity
Overall score: 34.78%
1 critical failure(s) triggered automatic parity downgrade.
