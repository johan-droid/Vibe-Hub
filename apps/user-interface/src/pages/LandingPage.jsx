      ...
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between rounded-[3rem] border border-white/40 bg-white/60 px-12 py-4 backdrop-blur-3xl shadow-2xl shadow-black/[0.03]">
        <button onClick={() => navigate('/')} className="flex items-center gap-6 group">
          ...
          <div className="text-left">
            <p className="text-3xl font-black tracking-tighter text-on-surface leading-none">Selina</p>
            <p className="mt-2 text-[11px] font-black uppercase tracking-[0.5em] text-google-blue">Intelligence Labs</p>
          </div>
        </button>

        <div className="hidden lg:flex items-center gap-14">
          {['Platform', 'Experts', 'Security', 'Pricing'].map((item) => (
            <a key={item} href={`#${item.toLowerCase()}`} className="text-sm font-black uppercase tracking-[0.2em] text-on-surface/70 hover:text-google-blue transition-all">
              {item}
            </a>
          ))}
        </div>
        ...
        <div className="flex items-center gap-6">
          {user ? (
            ...
            <>
              <button className="hidden sm:block text-sm font-black uppercase tracking-widest text-on-surface/70 hover:text-on-surface transition-colors">Sign In</button>
    ...
    <div className="relative min-h-screen selection:bg-google-blue/10 selection:text-google-blue font-sans overflow-x-hidden">
      ...
      <main>
        ...
        <section className="relative px-10 pb-32 pt-64 md:pb-48 md:pt-80">
          <motion.div style={{ scale: heroScale, opacity: heroOpacity }} initial="hidden" animate="show" variants={stagger} className="mx-auto max-w-7xl text-center relative z-10">
            ...
            <motion.h1 variants={fadeUp} className="text-8xl font-black leading-[0.9] tracking-tighter md:text-[11rem] lg:text-[13rem] text-on-surface">
              Build anything <br />
              <span className="text-google-blue italic">with precision.</span>
            </motion.h1>

            <motion.p variants={fadeUp} className="mx-auto mt-20 max-w-4xl text-2xl leading-relaxed text-on-surface/80 md:text-3xl font-semibold">
            ...
            <motion.div variants={fadeUp} className="mt-24 flex flex-col items-center justify-center gap-10 sm:flex-row">
              ...
              <button className="flex items-center gap-6 text-2xl font-black text-on-surface-variant/70 hover:text-on-surface transition-all group">
            ...
            <motion.div variants={fadeUp} className="mt-40 flex flex-wrap justify-center items-center gap-20 text-[11px] font-black uppercase tracking-[0.6em] text-on-surface/60">
            ...
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true, margin: "-100px" }} variants={stagger} className="grid gap-16 md:grid-cols-2 lg:grid-cols-4">
              {features.map((f, i) => (
                ...
                >
                  ...
                  <h3 className="text-4xl font-black text-on-surface tracking-tighter mb-8">{f.title}</h3>
                  <p className="text-xl text-on-surface/70 leading-relaxed font-semibold">{f.desc}</p>
                </motion.div>
              ))}
            </motion.div>
          </div>
                    ...
                    <div className="flex flex-1 p-16 gap-16">
                       ...
                       <div className="flex-1 rounded-[4.5rem] bg-white shadow-3xl shadow-black/[0.03] flex items-center justify-center relative overflow-hidden group/inner">
                          ...
                          <div className="text-center relative z-10">
                             ...
                             <h4 className="text-5xl font-black text-on-surface tracking-tighter">Performance Optimal</h4>
                             <p className="mt-6 text-2xl text-on-surface/50 font-black uppercase tracking-[0.4em]">Core nodes healthy</p>
                          </div>
                       </div>
                    </div>
                 </div>
        ...
        <section className="px-10 py-64 bg-white relative overflow-hidden">
           ...
           <div className="mx-auto max-w-7xl relative z-10">
              <div className="text-center mb-32 space-y-8">
                 <h2 className="text-6xl font-black tracking-tighter text-on-surface">Built for the next generation.</h2>
                 <p className="text-2xl text-on-surface/70 font-semibold max-w-3xl mx-auto leading-relaxed">We combine autonomous intelligence with professional-grade security to redefine the boundaries of software creation.</p>
              </div>
                 ...
                 {values.map((v, i) => (
                    ...
                    >
                       ...
                       <div className="space-y-6">
                          <h3 className="text-3xl font-black text-on-surface tracking-tight">{v.title}</h3>
                          <p className="text-xl text-on-surface/70 font-semibold leading-relaxed">{v.desc}</p>
                       </div>
                    </motion.div>
                 ))}
              </div>
        ...
        <section className="px-10 py-40">
          <div className="mx-auto max-w-7xl rounded-[6rem] bg-google-blue p-20 md:p-40 text-center relative overflow-hidden shadow-4xl shadow-google-blue/30 group">
             ...
             <div className="relative z-10">
                ...
                <p className="text-3xl text-white/90 mb-24 max-w-4xl mx-auto font-black uppercase tracking-[0.25em] leading-relaxed">Join thousands of teams building the autonomous era with Selina.</p>
      ...
      <footer className="bg-[#faf8f5] border-t border-black/[0.03] px-10 py-48 md:px-16">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-32 lg:grid-cols-[2fr_3fr]">
            <div className="space-y-16">
              <div className="flex items-center gap-10">
                <BrandMark size="lg" />
                 <div>
                  <p className="text-5xl font-black tracking-tighter text-on-surface leading-none">Selina</p>
                  <p className="mt-3 text-[12px] font-black uppercase tracking-[0.6em] text-google-blue">Intelligence Infrastructure</p>
                </div>
              </div>
              <p className="max-w-md text-2xl leading-relaxed text-on-surface/70 font-semibold">
              ...
              <div className="flex flex-wrap gap-8">
                 <div className="flex items-center gap-5 rounded-[1.5rem] bg-white border border-black/[0.04] px-8 py-5 shadow-sm group hover:border-google-green/20 transition-all">
                    ...
                    <span className="text-[11px] font-black text-google-green tracking-[0.3em]">SYSTEM_OPERATIONAL</span>
                 </div>
                 <div className="flex items-center gap-5 rounded-[1.5rem] bg-white border border-black/[0.04] px-8 py-5 shadow-sm group hover:border-google-blue/20 transition-all">
                    <Fingerprint size={18} className="text-on-surface/50 group-hover:text-google-blue transition-colors" />
                    <span className="text-[11px] font-black text-on-surface/60 tracking-[0.3em]">SECURE_INSTANCE_V4.1</span>
                 </div>
              </div>
            </div>
            ...
            <div className="grid gap-20 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div key={group.title}>
                  <h3 className="text-[11px] font-black uppercase tracking-[0.5em] text-on-surface/50 mb-14">{group.title}</h3>
                   <div className="space-y-10">
                    {group.links.map((link) => (
                      <a key={link} href="#" className="block text-xl font-bold text-on-surface/70 hover:text-google-blue transition-all hover:translate-x-2">
                        {link}
                      </a>
                    ))}
                  </div>
          ...
          <div className="mt-48 flex flex-col justify-between gap-16 border-t border-black/[0.05] pt-20 text-xs font-black text-on-surface-variant/50 md:flex-row md:items-center">
